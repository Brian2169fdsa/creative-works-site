...
// Note: A "Professional Services Retainer" (recurring) is intentionally NOT included here.
// Add it only when a recurring Stripe Price ID is available, with mode: "subscription".
