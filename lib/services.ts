...
export const SERVICES: ServiceConfig[] = [
  ...
  },
  {
    ...
    related: ["motion-graphics", "marketing", "ai-development"],
    cta: {
  ...
  },
  {
    ...
    tagline: "Animation and motion that brings brands to life.",
    short: "We design and animate motion graphics, from logo animations and explainer videos to social content and full brand motion systems, that make your message impossible to ignore.",
    ...
    problem: {
      ...
      lead: "Attention is the scarcest resource online, and static images and plain text are losing the battle. Motion captures the eye, communicates complex ideas in seconds, and makes brands feel modern, alive, and worth paying attention to.",
      items: [
        "Static posts that blend into the feed and get ignored",
        "Complex ideas that take paragraphs to explain but could be shown in seconds",
        "Brand presentations that feel flat and outdated",
        "No animated assets to make social content stand out",
        "Video content that lacks polish because it has no motion design layer",
        "Competitors with more dynamic, professional-looking content",
      ],
      columns: 2,
    },
    features: {
      eyebrow: "What We Create",
      title: "Animation for every use case and platform.",
      items: [
        { title: "Logo Animation", desc: "A polished, animated version of your logo for intros, outros, and anywhere your brand needs to make an entrance." },
        { title: "Explainer Videos", desc: "Animated explainers that break down complex services, processes, or ideas in 60 to 90 seconds." },
        { title: "Social Motion Content", desc: "Animated posts, stories, and reels that stop the scroll and communicate your message at a glance." },
        { title: "Lower Thirds and Titles", desc: "Branded animated text overlays for interview and documentary-style video production." },
        { title: "Animated Infographics", desc: "Data and statistics brought to life through motion so they are memorable, not just readable." },
        { title: "Brand Motion Systems", desc: "A complete library of animated components, transitions, and templates that keep every output on brand." },
      ],
    },
    sections: [
      {
        type: "callout" as const,
        tone: "navy",
        eyebrow: "AI-Accelerated Motion",
        title: "Faster production. Higher output. Same quality.",
        body: "We integrate the latest AI-powered motion tools into our workflow, enabling faster turnaround on complex animations, more creative iteration, and higher-volume output without sacrificing craft. You get motion graphics at a pace and price point that was not possible even a year ago.",
        points: [
          "AI-assisted animation for faster first drafts and more creative options",
    ...
    process: {
      eyebrow: "How It Works",
      title: "From concept to finished motion.",
      steps: [
        { title: "Creative Brief", desc: "We learn your brand, your audience, and what the animation needs to accomplish." },
        { title: "Style and Storyboard", desc: "We develop a visual direction and storyboard so you know exactly what you are approving before production begins." },
        { title: "Animation and Production", desc: "We build and animate the piece, keeping you updated as each section comes together." },
        { title: "Revisions", desc: "You review a draft and give feedback. We refine until every frame is exactly right." },
        { title: "Delivery and Assets", desc: "We deliver finished files in every format you need, plus source files if you want them." },
      ],
    },
    benefits: {
      title: "What motion graphics give your brand.",
      items: [
        { title: "More attention", desc: "Motion outperforms static in nearly every engagement metric on every major platform." },
        { title: "Faster communication", desc: "A well-made animation communicates in seconds what paragraphs of copy cannot." },
        { title: "Premium brand perception", desc: "Motion signals investment and professionalism that static content simply cannot match." },
        { title: "Reusable assets", desc: "A motion system you build once gets used across every campaign, every channel, every quarter." },
        { title: "Better video content", desc: "Motion graphics elevate raw video, making every production look more polished and intentional." },
        { title: "Competitive edge", desc: "Most organizations in the behavioral health space are not doing motion well. Be the one that is." },
      ],
    },
    related: ["video-editing", "marketing", "ai-development"],
    cta: {
      title: "Ready to bring your brand to life?",
      body: "Schedule a consultation and let us show you what motion can do for your content.",
    },
  },
];
